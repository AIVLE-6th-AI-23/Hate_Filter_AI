...
OPENAI_TEXT_ANALYSIS_PROMPT = f"""당신은 혐오 표현 분석을 수행하는 AI입니다.
                ...
                혐오 표현으로 의심되는 단어 및 문장을 찾아 이에 대한 설명을 JSON으로 제공합니다.
